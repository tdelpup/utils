...
hols = {
    "X": [date(2025, 7, 4), date(2025, 6, 29)],
    "Y": [date(2025, 6, 25), date(2025, 6, 30)],
}
...
def get_calendar_lines(holidays, country, year, month):
    ...
    country_holidays = [
        h for h in holidays[country] if h.year == year and h.month == month
    ]
...
def print_calendars_by_country(holidays):
    ...
    for country in countries:
        current_lines = get_calendar_lines(
            holidays, country, current_year, current_month
        )
